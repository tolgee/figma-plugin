...
export interface paths {
    ...
    "/v2/projects/keys/trash/select-all": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v2/projects/keys/trash/{keyId}": {
        ...
        delete: operations["permanentlyDelete_1"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/v2/projects/keys/trash/{keyId}/restore": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v2/projects/start-batch-job/hard-delete-keys": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["hardDeleteKeys_1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        QaIssueModel: {
            ...
            state: "OPEN" | "IGNORED";
            /** @enum {string} */
            type: "EMPTY_TRANSLATION" | "SPACES_MISMATCH" | "UNMATCHED_NEWLINES" | "TRIM_CHECK" | "CHARACTER_CASE_MISMATCH" | "MISSING_NUMBERS" | "REPEATED_WORDS" | "PUNCTUATION_MISMATCH" | "SPELLING" | "GRAMMAR" | "BRACKETS_MISMATCH" | "BRACKETS_UNBALANCED" | "SPECIAL_CHARACTER_MISMATCH" | "DIFFERENT_URLS" | "KEY_LENGTH_LIMIT" | "INCONSISTENT_PLACEHOLDERS" | "INCONSISTENT_HTML" | "HTML_SYNTAX" | "ICU_SYNTAX";
        };
        ...
        SingleStepImportResolvableTranslationRequest: {
            /**
             * @description To ensure the import doesn't override something that should not be (in case data have changed unexpectedly),
    ...
    selectKeys_3: {
        parameters: {
            query?: {
                ...
                filterQaCheckType?: ("EMPTY_TRANSLATION" | "SPACES_MISMATCH" | "UNMATCHED_NEWLINES" | "TRIM_CHECK" | "CHARACTER_CASE_MISMATCH" | "MISSING_NUMBERS" | "REPEATED_WORDS" | "PUNCTUATION_MISMATCH" | "SPELLING" | "GRAMMAR" | "BRACKETS_MISMATCH" | "BRACKETS_UNBALANCED" | "SPECIAL_CHARACTER_MISMATCH" | "DIFFERENT_URLS" | "KEY_LENGTH_LIMIT" | "INCONSISTENT_PLACEHOLDERS" | "INCONSISTENT_HTML" | "HTML_SYNTAX" | "ICU_SYNTAX")[];
