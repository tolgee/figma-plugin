...
export async function sendTolgeeRequest(endpoint: string, method: "POST" | "PUT" | "GET" | "DELETE", tolgeeConfig: Omit<TolgeeConfig, "lang">, body?: string): Promise<{ status: number, data: any | null } | null> {
  if (!tolgeeConfig) {
