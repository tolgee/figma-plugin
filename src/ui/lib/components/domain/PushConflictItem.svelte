...
<div
  class="grid grid-cols-[1fr_1fr_auto] items-start gap-2 border-b border-border py-2 last:border-b-0"
>
  <div class="min-w-0">
    <div
      class="truncate text-[10px] font-medium text-text-secondary"
    ...
    <div
      class="mt-0.5 line-clamp-2 text-xs whitespace-pre-wrap wrap-break-word text-text"
      title={figmaText}
    >
      {figmaText || "(empty)"}
    </div>
    <div class="mt-1 text-[10px] text-text-secondary">Figma</div>
  </div>

  <div class="min-w-0">
    <div
      class="line-clamp-2 text-xs whitespace-pre-wrap wrap-break-word text-text"
      title={remoteText}
    >
      {remoteText || "(empty)"}
    </div>
    <div class="mt-1 text-[10px] text-text-secondary">Tolgee</div>
  </div>
