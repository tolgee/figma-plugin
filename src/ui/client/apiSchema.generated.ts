...
export interface paths {
  ...
  "/v2/projects/language/{languageId}/key/{keyId}/suggestion": {
    /** Get suggestions */
    get: operations["getSuggestions_1"];
    /** Create translation suggestion */
    post: operations["createSuggestion_1"];
  };
  "/v2/projects/language/{languageId}/key/{keyId}/suggestion/{suggestionId}": {
    /** Delete suggestion */
    delete: operations["deleteSuggestion_1"];
  };
  "/v2/projects/language/{languageId}/key/{keyId}/suggestion/{suggestionId}/accept": {
    /** Accept suggestion */
    put: operations["acceptSuggestion_1"];
  };
  "/v2/projects/language/{languageId}/key/{keyId}/suggestion/{suggestionId}/decline": {
    /** Decline suggestion */
    put: operations["declineSuggestion_1"];
  };
  "/v2/projects/language/{languageId}/key/{keyId}/suggestion/{suggestionId}/reverse": {
    /** Reverse suggestion */
    put: operations["reverseSuggestion_1"];
  };
...
export interface components {
  schemas: {
    ...
    ImportTranslationModel: {
      ...
      conflictText?: string;
      /** @enum {string} */
      conflictType?: "CANNOT_EDIT_REVIEWED" | "CANNOT_EDIT_DISABLED" | "SHOULD_NOT_EDIT_REVIEWED";
